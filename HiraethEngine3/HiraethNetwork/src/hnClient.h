...
// towards the server. The data pointer must be a valid data type and it must exist for as long as the variable 
// exists
extern HN_API inline void hnClientHookVariable(HnClient* client, const std::string& name, void* data);
...
extern HN_API inline void hnLocalClientHookVariable(HnClient* client, HnLocalClient* localclient, const std::string& name, void* data);
