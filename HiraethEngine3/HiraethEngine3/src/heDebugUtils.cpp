    ...
    if(args[0] == "print") {
        ...
        if(args[1] == "instances") {
            ...
            for(auto const& all : files) {
                HE_LOG("File: " + all.name);
                heBinaryConvertD3InstanceFile(all.fullPath, "bin/" + all.fullPath);
            }
            found = true;
        }
        ...
        if(args[1] == "texture") {
            ...
            heTextureCompress(args[2], args[3]);
            found = true;
        }
        ...
        if(args[1] == "textures") {
            ...
            for(auto& all : files) {
                HE_LOG("File: " + all.name);
                heTextureCompress(all.fullPath, "bin/" + all.fullPath);
            }
            found = true;
        }
    }
