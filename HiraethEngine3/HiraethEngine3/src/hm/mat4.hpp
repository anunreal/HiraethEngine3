...
namespace hm {
    ...
    template<typename T>
        ...
        mat4(const T* ptr) {
            columns[0] = col(ptr[0], ptr[1], ptr[2], ptr[3]);
            columns[1] = col(ptr[4], ptr[5], ptr[6], ptr[7]);
            columns[2] = col(ptr[8], ptr[9], ptr[10], ptr[11]);
            columns[3] = col(ptr[12], ptr[13], ptr[14], ptr[15]);
        };
