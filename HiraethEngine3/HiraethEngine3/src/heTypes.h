...
typedef enum HeColourFormat {
    ...
    HE_COLOUR_FORMAT_COMPRESSED_RGB8   = 0x84ED,
    HE_COLOUR_FORMAT_COMPRESSED_RGBA8   = 0x84EE,
} HeColourFormat;
...
typedef enum HeTextureParameter {
    HE_TEXTURE_NONE               = 0b00000000,
    HE_TEXTURE_FILTER_LINEAR      = 0b00000001,
    HE_TEXTURE_FILTER_BILINEAR    = 0b00000010,
    HE_TEXTURE_FILTER_TRILINEAR   = 0b00000100,
    HE_TEXTURE_FILTER_ANISOTROPIC = 0b00001000,
    HE_TEXTURE_CLAMP_EDGE         = 0b00010000,
    HE_TEXTURE_CLAMP_BORDER       = 0b00100000,
    HE_TEXTURE_CLAMP_REPEAT       = 0b01000000,
} HeTextureParameter;
